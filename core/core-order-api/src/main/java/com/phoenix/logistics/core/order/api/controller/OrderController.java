...
public class OrderController {
    ...
    public ApiResponse<Order> createOrder(@RequestBody CreateOrderRequest request) {
        ...
        Order order = orderService.save(request.manufacturerUuid(), request.vendorUuid(), request.fullAddress(),
                request.recipientName(), request.recipientSlackId(), productOrderList);
